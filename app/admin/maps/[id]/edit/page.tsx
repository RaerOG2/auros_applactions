...
export default function EditMapPage() {
  ...
  async function handleSave(
    ...
    /*
     * Keep the editor data in sync after saving.
     *
     * This is especially important when DEV mode
     * forces current=false in the service.
     */
    setInitialValue({
      name:
        updated.name ??
